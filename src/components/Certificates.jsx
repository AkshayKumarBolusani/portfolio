...
const Certificates = () => {
  ...
  // Create infinite loop by duplicating certificates once
  const duplicatedCertificates = [...certificates, ...certificates];

  const openModal = (certificate, index) => {
    // Get the clicked certificate element position
    ...
    if (certificateElement) {
      ...
      // Calculate center position of the clicked certificate
          ...
          <div className="certificates-scroll">
            {duplicatedCertificates.map((certificate, index) => (
              <motion.div
                ...
                onClick={(e) => openModal(certificate, index)}
